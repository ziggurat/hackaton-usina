...
class ConsultorTramites:
    def __init__(self, collection_name=None, model_name=None, db_path=None, embed_model=None, top_k=None):
        """
        ...
        """
        # Mover defaults al interior de la función
